...
var countDownRating = document.querySelector('.js-countdown');
var nextMeetingStart = countDownRating.dataset.countdown;

	var target_date= new Date(nextMeetingStart * 1000).getTime(); // set the countdown date
