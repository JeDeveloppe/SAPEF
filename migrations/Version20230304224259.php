 ...
 */
final class Version20230304224259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD fonction_id INT DEFAULT NULL, ADD is_bureau TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP fonction_id, DROP is_bureau');
    }
}
