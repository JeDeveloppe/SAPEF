 ...
 */
final class Version20230923185327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE department (id INT AUTO_INCREMENT NOT NULL, region_erm_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, code_map VARCHAR(255) NOT NULL, number VARCHAR(3) NOT NULL, INDEX IDX_CD1DE18A2971434C (region_erm_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
