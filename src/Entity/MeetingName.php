...
#[ORM\Entity(repositoryClass: MeetingNameRepository::class)]
class MeetingName
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'name', targetEntity: Meeting::class)]
